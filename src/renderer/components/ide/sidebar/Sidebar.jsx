...
export default function Sidebar({
  ...
  return (
    <motion.div
      ...
      animate={{ width, opacity: 1, transition: isResizing ? { duration: 0 } : { duration: 0.45, ease: [0.16, 1, 0.3, 1] } }}
      exit={{ width: 0, opacity: 0, transition: { duration: 0.18, ease: [0.4, 0, 1, 1] } }}
      onMouseDown={() => onFocus?.()}
    >
