...
contextBridge.exposeInMainWorld('foundry', {
  ...
  gitCommitCount: (dirPath, branch) => ipcRenderer.invoke('git:commitCount', dirPath, branch),
  ...
  gitStash: (dirPath, message) => ipcRenderer.invoke('git:stash', dirPath, message),
  gitStashList: (dirPath) => ipcRenderer.invoke('git:stashList', dirPath),
  gitStashPop: (dirPath, ref) => ipcRenderer.invoke('git:stashPop', dirPath, ref),
  gitStashApply: (dirPath, ref) => ipcRenderer.invoke('git:stashApply', dirPath, ref),
  gitStashDrop: (dirPath, ref) => ipcRenderer.invoke('git:stashDrop', dirPath, ref),
